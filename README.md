...
- [exp 4](exp-4/exp-4.md): Análise e estabelecimento das relações entre os dados retornados por dois endpoints.
- [exp 5](exp-5/exp-5.md): Utilização de um endpoint mais geral, para construção e apresentação de um gráfico e de um mapa relativos ao consumo de energia elétria.
